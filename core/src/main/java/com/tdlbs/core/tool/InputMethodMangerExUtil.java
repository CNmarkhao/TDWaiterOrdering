...
/**
 * ================================================
 * 创建时间：2018/10/16 09:20
 * 作者：markgu
 * 描述：InputMethodMangerExUtil
 * Email：<a href="mailto:guhao561@gmail.com">Contact me</a>
 * ================================================
 */
public class InputMethodMangerExUtil {
    ...
    public static void setEditTextUnReadOnly(TextView view) {
        if (view instanceof android.widget.EditText) {
