package com.tdlbs.core.ui.view;
...
public class CommonToolBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        setBackgroundColor(typedArray.getColor(R.styleable.CommonToolBar_background,
                getContext().getResources().getColor(R.color.blue_sky)));
        typedArray.recycle();
        ...
        mLeftView.getViewTreeObserver().addOnGlobalLayoutListener(() -> {
