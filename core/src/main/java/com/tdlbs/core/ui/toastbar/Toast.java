...
import com.tdlbs.core.ui.toastbar.util.Utils;

import java.util.HashSet;
import java.util.Set;

import static android.content.Intent.FLAG_ACTIVITY_NEW_TASK;
import static com.tdlbs.core.ui.toastbar.FloatWindowService.SERVICE_WINDOWS_PARENT;
...
public class Toast extends FrameLayout {
    ...
    long time;
    Set<ToastListener> mToastListeners = new HashSet<>();
