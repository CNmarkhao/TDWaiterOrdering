...
public class CubeLoadingView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mOriginPointX = getMeasuredWidth() / 2f - SIDE_LENGTH * cos30;
        mOriginPointY = getMeasuredHeight() / 2f - (10 * SIDE_LENGTH *sin30 + SIDE_LENGTH + SHADOW_DISTANCE) / 2 + 2 * SIDE_LENGTH * sin30;
