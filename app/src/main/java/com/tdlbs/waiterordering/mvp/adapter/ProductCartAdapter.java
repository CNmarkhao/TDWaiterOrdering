 ...
 * ================================================
 */
public class ProductCartAdapter extends BaseQuickAdapter<OrderDetail.Product, BaseViewHolder> {
    public ProductCartAdapter(@Nullable List<OrderDetail.Product> data) {
        super(R.layout.item_cart_product, data);
    }
